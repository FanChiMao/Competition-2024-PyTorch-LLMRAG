...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_path', type=str, default="./outputs/submission_edward_with_answer_50_25.json", help='輸出符合參賽格式的答案路徑')  # 答案輸出的路徑
    ...
    answer_dict = EdwardPipeline(args).run()  # 執行 EdwardPipeline
