...
if __name__ == "__main__":
    ...
    parser.add_argument('--question_path', type=str, default="./data/dataset/preliminary/questions_example.json", help='讀取發布題目路徑')  # 問題文件的路徑
    parser.add_argument('--source_path', type=str, default="./data/reference", help='讀取參考資料路徑')  # 參考資料的路徑
    parser.add_argument('--output_path', type=str, default="./output/baseline.json", help='輸出符合參賽格式的答案路徑')  # 答案輸出的路徑
